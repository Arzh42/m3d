...
//ça marche bien
 ...
 t_point3d *(*copierPoint3d)(t_point3d *t) = copierPoint3d_etu;
 ...
 void (*remplirTriangle3d)(t_surface * surface, t_triangle3d * triangle, Uint32 c, double l, double h, double d) = remplirTriangle3d_PA; //Pas optimal à améliorer
 ...
 t_point3d *(*centreGraviteObjet3d)(t_objet3d *o) = 								   centreGraviteObjet3d_etu;
 void (*dessinerObjet3d)(t_surface *surface, t_objet3d* pt_objet, t_objet3d *camera) = dessinerObjet3d_PA;

 void (*translationObjet3d)(t_objet3d* pt_objet, t_point3d *vecteur) = 				   translationObjet3d_etu;
